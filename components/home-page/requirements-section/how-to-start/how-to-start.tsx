      ...
      '
		...
		>
			...
			<p className='tracking-wider p-2 md:p-0 text-xs md:text-sm xl:text-base'>
				Profil Kandydata na Kierowcę czyli numer PKK trzeba wyrobić w
				wydziale komunikacji ze względu na zameldowanie. Do wyrobienia
				numeru PKK potrzebne są badania lekarskie, zdjęcie profil przód,
				dokument tożsamości (dowód osobisty lub paszport). Dodatkowo,
				jeżeli jest się osobą niepełnoletnią, wymagana jest również
				zgoda rodzica. Wyrobiony profil przynosimy do OSK, aby wybrać
				rodzaj kursu.
			</p>
			<div className='flexCenter gap-2 xl:gap-4 mt-4'>
				<DocuementBtn
					...
					style='bg-main-page-color text-white border-solid border-2 border-[var(--main-page-color)]'
				/>
				<DocuementBtn
