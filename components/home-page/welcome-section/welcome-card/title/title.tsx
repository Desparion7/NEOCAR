	...
	return (
		<div className=' flex flex-col items-center py-0 lg:py-2 lg:gap-2 '>
			...
			<div className='flexCenter text-lg s:text-xl lg:text-3xl xl:text-4xl 2xl:text-5xl text-[var(--text-white-1)] font-bold w-full z-20'>
				<AnimateText
					text='Ośrodek Szkolenia Kierowców '
					style=''
					el='h1'
				/>
			</div>
			<p className='flexCenter flex-col mt-3 lg:mt-10 text-lg lg:text-2xl z-10 text-[var(--text-white-1)] font-semibold'>
				Szkolimy na kategorie A, A1, A2, B
			</p>
			<NavigateBtn
