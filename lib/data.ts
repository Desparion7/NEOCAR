...
export const pricePlans = [
	{
		...
		characteristic: [
			...
			'jazda po placu egzaminacyjnym WORD lub jedna dodatkowa godzina jazdy gratis',
			'wszelkie niezbędne materiały do nauki i dostęp do bazy pytań',
			'możliwość rozłożenia płatności na raty',
			'e-learning',
			'Zajęcia praktyczne na: Hyundai i20, Fiat 500, Audi A1',
			'Wszystkie samochody mamy z manualną skrzynią biegów i podstawiamy na egzamin państwowy w WORD.',
		],
	},
	{
		id: 'STANDARDOWY',
	...
	{
		id: 'EKSTERNISTYCZNY-A',
		title: 'Kurs podstawowy kat. B - Automat',
		planTitle: 'EKSTERNISTYCZNY',
		price: '2590',
		...
		characteristic: [
			...
			'możliwość rozłożenia płatności na raty',
			'e-learning',
			'Zajęcia praktyczne na: TESLA MODEL 3',
			'Samochód podstawiamy na egzamin państwowy w WORD.',
		],
	},
	{
		id: 'STANDARDOWY-A',
